  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          // The checked translation must be direction-aware: in RTL the thumb
          // starts at the right edge, so "on" moves it toward the LEFT. A
          // physical translate-x alone pushes the knob outside the track in
          // RTL. Using mutually exclusive ltr:/rtl: variants makes the rule
